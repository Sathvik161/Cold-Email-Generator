...
class Chain:
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            ...
            ### INSTRUCTION:
            You are Vikas, a business development executive at TCS. TCS is an AI & Software Consulting company dedicated to facilitating
            ...
            Remember you are Vikas, BDE at TCS. 
